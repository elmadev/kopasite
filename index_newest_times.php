...
$result = mysql_query("SELECT time.Time, time.EOLVerify, time.Verify, time.TimeIndex, time.Apples, time.KuskiIndex, time.Driven, time.LevelIndex, time.Position FROM time ORDER BY TimeIndex DESC LIMIT $limit");
$no = 0;
